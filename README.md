...
```
https://cdn.jsdelivr.net/gh/bgpeer@main/rules/geo/rules/geosite
```

### Loy_GeoIP:[ip规则集目录](https://github.com/bgpeer/tree/main/rules/geo/rules/geoip)
```
https://cdn.jsdelivr.net/gh/bgpeer@main/rules/geo/rules/geoip
```
...
### Loy-GeoSite:[sing-box目录](https://github.com/bgpeer/tree/main/rules/geo/sing/geosite)
```
https://cdn.jsdelivr.net/gh/bgpeer@main/rules/geo/sing/geosite
```

### Loy-GeoIP:[sing-box目录](https://github.com/bgpeer/tree/main/rules/geo/sing/geoip)
```
https://cdn.jsdelivr.net/gh/bgpeer@main/rules/geo/sing/geoip
```
